...
def RealTimeCurrencyConversion():
    ...
    try:
        if (Amount1_field.get() == ""):
            ...
            Amount2_field.delete(0, END)  # Clear previous result
            Amount2_field.insert(0, str(new_amount))
    except RatesNotAvailableError as e:
      tkinter.messagebox.showinfo("Error !!", "Currency Rates Source Not Ready.\n Please try again later.")
      logging.error("Currency Rates Source Not Ready: %s", e)
